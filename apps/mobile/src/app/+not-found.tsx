      ...
      <SafeAreaView style={styles.safeArea}>
        <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
          ...
          <View style={styles.mainContent}>
            <Text style={styles.title}>¡Ups! Esta pantalla no existe (aún).</Text>

            <Text style={styles.subtitle}>
              Parece que "<Text style={styles.boldText}>/{missingPath}</Text>" no es parte de tu
              proyecto. ¡Pero no te preocupes, tienes opciones!
            </Text>
              ...
              <View style={styles.createPageContainer}>
                <View style={styles.createPageContent}>
                  <View style={styles.createPageTextContainer}>
                    <Text style={styles.createPageTitle}>Construir desde cero</Text>
                    <Text style={styles.createPageDescription}>
                      Crear una nueva pantalla para vivir en "/{missingPath}"
                    </Text>
                  </View>
                  <View style={styles.createPageButtonContainer}>
                    ...
                    >
                      <Text style={styles.createPageButtonText}>Crear Pantalla</Text>
                    </TouchableOpacity>
                  </View>
                </View>
              </View>
            ...
            <Text style={styles.routesLabel}>Revisa todas las rutas de tu proyecto aquí ↓</Text>
